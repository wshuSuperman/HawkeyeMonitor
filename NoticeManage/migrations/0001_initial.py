    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notice_title', models.CharField(max_length=50, verbose_name='通知标题')),
                ...
                ('notice_type', models.CharField(choices=[('notice', '任务通知'), ('sysinfo', '系统通知')], max_length=30, verbose_name='通知类型')),
                ('notice_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='通知日期')),
